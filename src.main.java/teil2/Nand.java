...
public class Nand {
	...
	private int numberOfChangesInSetupPhase;
	...
	public void setOutputValue() {
		...
		if (!(Event.getEventQueue().isStarted() || output.hasSteadyState())) {
			numberOfChangesInSetupPhase++;
		...
		// new Event(output, Event.getEventQueue().getRunTime() + waitTime,
		// calculatedValue);
		// } else {
		// output.setValue(calculatedValue);
		// }
